...
use tensorzero_inference_types::{
    ...
    RequestMessage, TextChunk, ThoughtChunk, Usage, {FileUrl, LazyFile, LazyFileExt},
};
...
mod tests {
    use super::*;
    use crate::providers::test_helpers::MULTI_PROVIDER_TOOL_CONFIG;
    use crate::providers::test_helpers::QUERY_TOOL;
    use crate::providers::test_helpers::ToolCallConfig;
    use crate::providers::test_helpers::WEATHER_PROVIDER_TOOL_CONFIG;
    use crate::providers::test_helpers::WEATHER_TOOL;
    use serde_json::json;
    use std::borrow::Cow;
